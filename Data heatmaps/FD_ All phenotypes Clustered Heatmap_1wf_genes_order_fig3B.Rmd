...
gene_order <- c("Mhcl_TRIP (MYO18B)","CG34015_TRIP (HINT3)","Pkc53E_GD (PRKCA)","yip2_GD (ACAA1)", "Tengl2_GD (EXOG)", "Fhos_GD (FHOD3)", "Gprk1_TRIP (GRK3)",  "CG11050_TRIP (HDDC2)", "Nos_TRIP (NOS1)", "DAT_KK (SLC6A2)")
...
png("Gene KD Expression Effect Patterns Across All Parameters 1wf_Fig3B.png", width = 5000, height = 9000, res = 300) # Adjust (width + height) to control the size of the heatmap image.
