...
file_path <- file.path(WORKING_DIR, "All_phenotypes_1wm_1wf_fold_change_table_adjusted_for_clustered_heatmap_sheets.xlsx")
...
gene_order <- c("Acat2_KK (ACAA1)", "Acat2_TRIP (ACAA1)", "Mtpβ_KK (ACAA1)", "Mtpβ_TRIP (ACAA1)", "Dyb_KK (DTNA)", "Dyb_TRIP (DTNA)", "Pgant5_KK (GALNT1)", "Pgant5_GD (GALNT1)", "Plc21C_KK (PLCD3)", "Plc21C_GD (PLCD3)","Helz_KK (HELZ)", "Helz_TRIP (HELZ)", "fray_KK (OXSR1)", "fray_GD (OXSR1)")
...
png("Gene KD Expression Effect Patterns Across All Parameters 1wm_GpeA.png", width = 5000, height = 9000, res = 300) # Adjust (width + height) to control the size of the heatmap image.
