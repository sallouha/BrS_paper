...
gene_order <- c("Srlp_GD (ECHDC1)", "Srlp_TRIP (ECHDC1)")
...
png("Gene KD Expression Effect Patterns Across All Parameters 1wf_GpeAa.png", width = 5000, height = 9000, res = 300) # Adjust (width + height) to control the size of the heatmap image.
...
pheatmap(
  ...
  color = colors,
  number_color = "black",
  main = "Gene KD Expression Effect Patterns Across All Parameters 1wf"
)
dev.off()
