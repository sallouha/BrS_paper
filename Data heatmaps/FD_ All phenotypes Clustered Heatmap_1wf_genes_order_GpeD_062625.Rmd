...
gene_order <- c("Acat1_KK (ACAA1)", "Acat1_GD (ACAA1)", "Est-P_GD (CES5A)", "Est-P_TRIP (CES5A)", "EndoG_KK (EXOG)", "EndoG_GD (EXOG)",  "Hey_KK (HEY2)", "Hey_TRIP (HEY2)",  "arr_GD_1 (LRP12)", "arr_GD_2 (LRP12)", "CCAP-R_KK (NPSR1)", "CCAP-R_GD (NPSR1)", "Cpsf5_KK (NUDT21)", "Cpsf5_TRIP (NUDT21)","CG6931_KK (TPGS2)", "CG6931_GD (TPGS2)", "CG1074_KK (TRMT11)", "CG1074_GD (TRMT11)", "Smurf_KK (SMURF2)", "Smurf_GD (SMURF2)", "CG42450_KK (RGS9)", "CG42450_GD (RGS9)", "CG9018_GD (RPRD1A)", "CG9018_TRIP (RPRD1A)", "Jhedup_KK (CES5A)", "Jhedup_GD (CES5A)" )
...
png("Gene KD Expression Effect Patterns Across All Parameters 1wm_GpeD.png", width = 5000, height = 9000, res = 300) # Adjust (width + height) to control the size of the heatmap image.
